...
# MAGIC > notebook `00_poblar_lakebase` desde la tabla Delta `{UC_CATALOG}.{UC_SCHEMA}.productos`.
...
# Usamos la tabla real de productos (poblada desde Delta por el notebook 00_poblar_lakebase).
