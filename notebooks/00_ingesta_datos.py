...
# MAGIC > entrada del medallón. Desde aquí, `05_bootstrap_datos` sirve estos datos a Lakebase.
...
# MAGIC 1. **`05_bootstrap_datos`** — sirve estos datos a Lakebase (embeddings + geometrías).
